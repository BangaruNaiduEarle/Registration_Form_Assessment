...
function test() {
    ...
    let InstituteNameEl = document.getElementById("InstituteName");
    let selectedIdEl = document.getElementById("selectedId");
    ...
    let profile = {
        ...
        InstituteName: InstituteNameEl.value,
        selectedId: selectedIdEl.value,
